...
from models.retinanet.anchor_utils import AnchorGenerator
from models.retinanet.transform import GeneralizedRCNNTransform
from models.retinanet.backbone_utils import resnet_fpn_backbone, _validate_trainable_layers
from models.retinanet.feature_pyramid_network import LastLevelP6P7
from models.retinanet.focal_loss import sigmoid_focal_loss
from models.retinanet.boxes import box_iou, clip_boxes_to_image, batched_nms
from models.retinanet.utils import Matcher, overwrite_eps, BoxCoder
    ...
    def __init__(self, in_channels, num_anchors, num_classes, prior_probability=0.01, module_name=""):
        ...
        for name, layer in self.conv.named_children():
            if isinstance(layer, nn.Conv2d):
                # TODO: I've blocked out shits that might not be necessary
